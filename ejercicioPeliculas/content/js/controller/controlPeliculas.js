function iniciarPrograma() {
    ...
    var rows = document.getElementById("vistaTablaPeliculas").getElementsByTagName("tr").length;
...
function buscarPelicula() {
    ...
    var pelicula = gestor.mostrarPelicula(document.getElementById("buscador").value);
    var html = "<tr><td>" + pelicula.id + "</td> <td>" + pelicula.titulo + "</td> <td>" + pelicula.director + "</td> <td>" + pelicula.fecha + "</td> <td>" + pelicula.valoracion + "</td></tr>";
